    ...
    private void setState(int state) {
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                msg.setText(R.string.view_header_hint_normal);
                break;
            case STATE_RELEASE_TO_REFRESH:
                if (!animationDrawable.isRunning()) {
                    animationDrawable.start();
                }
                msg.setText(R.string.view_header_hint_release);
                break;
            case STATE_REFRESHING:
                msg.setText(R.string.view_refreshing);
                break;
            case STATE_DONE:
                msg.setText(R.string.view_refresh_done);
                break;
            default:
        }
        mState = state;
